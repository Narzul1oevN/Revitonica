...
const features = [
  {
    ...
    title: "Доступно",
    description: "Гимнастика и массаж для самостоятельной практики в домашних условиях",
  ...
  {
    title: "Эффективно",
    description: "Доказана научными исследованиями и результатами 500 тысяч последователей",
  ...
  {
    title: "Безопасно",
    description: "Безопасная альтернатива агрессивным процедурам. Без возрастных ограничений",
  ...
  {
    title: "Научно",
    description: "Методика создана ученым и основана на принципах доказательной медицины",
    buttonText: "О методе",
    buttonLink: "#",
    iconColor: "text-purple-500", // Цвет иконки
  },
];
...
const Secion2 = () => {
  return (
    ...
    <section className="py-2 md:py-20 bg-gray-50">
...
const FeatureCard = ({ feature }) => {
    ...
    return (
        ...
        <div 
            className="p-6 sm:p-8 rounded-3xl shadow-lg border border-white/70 h-full flex flex-col items-center text-center 
        ...
        >
            ...
            <div className="absolute inset-0 z-0 opacity-10 rounded-3xl pointer-events-none 
            ...
            <div className={`relative z-10 mb-6 p-4 rounded-full shadow-inner bg-white/70`}> 
                ...
                >
                    ...
                    <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 1 0-1.22-.872l-3.236 4.532-2.354-2.353a.75.75 0 1 0-1.06 1.06l2.94 2.94a.75.75 0 0 0 1.082.016l3.87-5.419z" clipRule="evenodd" />
                </svg>
            </div>
